  ...
  return (
    <section className='h-full flex flex-col '>
      {/* bg-me_2 bg-cover bg-top sm:bg-cover   bg-no-repeat */}
        < Header/>
          <div className='flex flex-col p-auto h-full bg-me_2 bg-cover bg-center bg-repeat lg:bg-repeat-x md:bg-contain lg:bg-cover xl:bg-contain bg:scroll xl:bg-top border-4 justify-center text-white text-center'>
