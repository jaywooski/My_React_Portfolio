...
function Footer() {
  return (
    <div className='h-28 text-5xl flex justify-around border-4 border-blue-600 drop-shadow shadow-lg bg-gradient-to-r from-black to-blue-700 fixed w-full bottom-0 z-50'>
